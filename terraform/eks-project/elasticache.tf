...
#   name        = "${local.name_template}-redis-subnet-group"
#   description = "Subnet group for Redis Cache"
#   subnet_ids  = element(["${data.aws_subnet_ids.main_vpc_private_subnet.ids}"], 0)
...
#   name = "belmont-aca-invisalert-redis-subnet-group"
# }
